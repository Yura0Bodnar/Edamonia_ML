...
def train(events, dataset_path):
    ...
    table.to_csv('Train/Results/LightGBM_results.csv', index=False, encoding='utf-8-sig')
    ...
    custom_test_data.to_csv('Train/Results/LightGBM_predict.csv', index=False, encoding='utf-8-sig')
